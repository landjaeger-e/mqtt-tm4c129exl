...
//
//*****************************************************************************
#define BUTTONS_GPIO_PERIPH     SYSCTL_PERIPH_GPIOL
#define BUTTONS_GPIO_BASE       GPIO_PORTL_BASE

#define NUM_BUTTONS             2
#define USR_SW1                 GPIO_PIN_1
#define USR_SW2                 GPIO_PIN_2
#define TOP_BUTTON             USR_SW1
#define BOTTOM_BUTTON            USR_SW2
